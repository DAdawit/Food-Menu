...
export default function Home() {
  ...
  return (
    <main className="bg-[#0F0C0C] overflow-hidden">
      <Hero />
      <div className="mt-15">
        <div className="flex flex-col justify-center items-center gap-5 mt-10">
          ...
          <Image
            ...
            className=""
          />
          <h1 className=" text-secondary text-3xl font-serif">
            We Offer Top Notch
          </h1>
          <p className="text-secondary font-mono text-sm py-8 contaner mx-auto max-w-2xl px-5 text-center">
